...
function updateTimer() {
  const targetDate = new Date("november 8, 2025 20:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542974610491'; // Número para el primer botón
  const phoneNumber2 = '543816591298'; // Número para el segundo botón
  const phoneNumber3 = '543816591298'; // Número para el tercer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542804028004'; // Número para el primer botón
  const recipientNumber2 = '542974610491'; // Número para el segundo botón
  const recipientNumber3 = '543816591298'; // Número para el tercer botón
